...
questions_list = []
questions_list.append(Question('Кто основал Тинькофф?','Олег Тинькофф','Илон Маск','Мистер бист','Билл Гейтс'))
...
def show_correct(res):
    '''показать результат - установим переданный текст в надпись ''результат'' и поажем нужную панель'''
